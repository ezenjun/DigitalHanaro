...
// // 		return {
// // 			next() {
// // 				return { value: this._arr[idx++], done: idx > this._arr.length };
// // 			},
// // 		};
// // 	}
// // }
...
// // assert.deepStrictEqual(itStack.toArray(), [1, 2, 2, 4, 5]);
// assert.deepStrictEqual([...itStack], [1, 2, 2, 4, 5]);
